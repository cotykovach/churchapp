...
namespace ChurchApplication
{
    ...
    {
        private const int DEFAULT_BOTTOM_BORDER_THICKNESS_DIPS = 4;
        private const byte DEFAULT_BOTTOM_BORDER_COLOR_ALPHA = 0X26;
        private const int SELECTED_INDICATOR_THICKNESS_DIPS = 14;
        private int[] INDICATOR_COLORS = { 0x18315c, 0xe6e6ff };
        private int[] DIVIDER_COLORS = { 0xed5e5e };

        private const int DEFAULT_DIVIDER_THICKNESS_DIPS = 1;
        private const float DEFAULT_DIVIDER_HEIGHT = 1f;
        ...
        public SlidingTabStrip (Context context, IAttributeSet attrs) : base(context, attrs)
        {
            ...
            mBottomBorderPaint.Color = GetColorFromInteger(0x000000); //GRAY
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            //Thick Colored Underline Below Current Selection
            if (tabCount > 0)
            {
                ...
                //Create Vertical Divider Between Tabs
