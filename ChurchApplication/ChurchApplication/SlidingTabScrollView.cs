...
namespace ChurchApplication
{
    public class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        public SlidingTabScrollView(Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
        {
            ...
            //Make sure tab strips fill the viewed
            FillViewport = true;
            //background bar color 2b3649
            this.SetBackgroundColor(Android.Graphics.Color.Rgb(0x22, 0x2a, 0x38)); //Gray Color
        ...
        private void value_PageScrolled(object sender, ViewPager.PageScrolledEventArgs e)
        {
            ...
            {
                //if any of these apply, return, no need to scroll
                return;
            }
        ...
        private void PopulateTabStrip()
        {
            ...
            for (int i = 0; i <adapter.Count; i++)
            {
                ...
                tabView.Text = ((SlidingTabFragment.SliderPagerAdapter)adapter).GetHeaderTitle(i);
                tabView.SetTextColor(Android.Graphics.Color.WhiteSmoke);
        ...
        private void ScrollToTab(int tabIndex, int extraOffset)
        {
            ...
            {
                //no need to go furhter, dont scroll
                return;
            }
